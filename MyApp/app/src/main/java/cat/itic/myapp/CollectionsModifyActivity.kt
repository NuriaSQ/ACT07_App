...
class CollectionsModifyActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val games = mutableListOf("Mass Effect", "Silent Hill 2", "Yakuza 0")

        val recycler = findViewById<RecyclerView>(R.id.modifyGamesRecycler)
        recycler.layoutManager = LinearLayoutManager(this)
        recycler.adapter = ModifyGamesAdapter(games)
    ...
    class ModifyGamesAdapter(private val items: MutableList<String>) :
        RecyclerView.Adapter<ModifyGamesAdapter.GameHolder>() {
